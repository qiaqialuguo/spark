...
public interface SqlBaseParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitSetCollation(SqlBaseParser.SetCollationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExecuteImmediateQueryParam(SqlBaseParser.ExecuteImmediateQueryParamContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#executeImmediateArgument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExecuteImmediateArgument(SqlBaseParser.ExecuteImmediateArgumentContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#executeImmediateArgumentSeq}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExecuteImmediateArgumentSeq(SqlBaseParser.ExecuteImmediateArgumentSeqContext ctx);
	/**
